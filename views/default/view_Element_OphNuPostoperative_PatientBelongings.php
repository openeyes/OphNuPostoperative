...
<section class="element">
	<header class="element-header">
		...
		<div class="row data-row">
			<div class="large-2 column"><div class="data-label"><?php echo CHtml::encode($element->getAttributeLabel('jewlery'))?></div></div>
			<div class="large-10 column end"><div class="data-value"><?php echo $element->jewlery ? 'Yes' : 'No'?></div></div>
		</div>
		<div class="row data-row">
