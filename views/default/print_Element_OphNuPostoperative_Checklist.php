...
<table class="subtleWhite normalText">
	<tbody>
		...
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('take_home_ophthalmic_medication_and/or_analgesics_supplies'))?></td>
			<td><span class="big"><?php echo $element->take_home_ophthalmic_medication_and/or_analgesics_supplies ? 'Yes' : 'No'?></span></td>
		</tr>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('instructions'))?></td>
			<td><span class="big"><?php echo $element->instructions ? 'Yes' : 'No'?></span></td>
		</tr>
	</tbody>
</table>
