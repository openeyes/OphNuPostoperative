...
<section class="element">
	<header class="element-header">
		...
		<div class="row data-row">
			<div class="large-2 column"><div class="data-label"><?php echo CHtml::encode($element->getAttributeLabel('take_home_ophthalmic_medication_and/or_analgesics_supplies'))?></div></div>
			<div class="large-10 column end"><div class="data-value"><?php echo $element->take_home_ophthalmic_medication_and/or_analgesics_supplies ? 'Yes' : 'No'?></div></div>
		</div>
		<div class="row data-row">
			<div class="large-2 column"><div class="data-label"><?php echo CHtml::encode($element->getAttributeLabel('instructions'))?></div></div>
			<div class="large-10 column end"><div class="data-value"><?php echo $element->instructions ? 'Yes' : 'No'?></div></div>
		</div>
			</div>
</section>
