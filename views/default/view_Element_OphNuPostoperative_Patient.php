...
<section class="element">
	<header class="element-header">
		...
		<div class="row data-row">
			...
			<div class="large-10 column end"><div class="data-value"><?php echo $element->hand_off_to ? $element->hand_off_to->name : 'None'?></div></div>
		</div>
		<div class="row data-row">
			<div class="large-2 column"><div class="data-label"><?php echo CHtml::encode($element->getAttributeLabel('handing_off_from_id'))?></div></div>
			<div class="large-10 column end"><div class="data-value"><?php echo $element->handing_off_from ? $element->handing_off_from->name : 'None'?></div></div>
		</div>
		<div class="row data-row">
