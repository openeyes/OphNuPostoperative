...
<table class="subtleWhite normalText">
	<tbody>
		...
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('hand_off_from_id'))?></td>
			<td><span class="big"><?php echo $element->hand_off_from ? $element->hand_off_from->name : 'None'?></span></td>
		</tr>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('hand_off_to_id'))?></td>
			<td><span class="big"><?php echo $element->hand_off_to ? $element->hand_off_to->name : 'None'?></span></td>
		</tr>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('handing_off_from_id'))?></td>
			<td><span class="big"><?php echo $element->handing_off_from ? $element->handing_off_from->name : 'None'?></span></td>
		</tr>
		<tr>
