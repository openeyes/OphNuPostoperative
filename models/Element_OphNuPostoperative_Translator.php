...
/**
 * This is the model class for table "et_ophnupostoperative_translator".
 *
 ...
 * @property OphNuPostoperative_Translator_TranslatorPresent $translator_present
 */

class Element_OphNuPostoperative_Translator  extends  BaseEventTypeElement
{
	public $service;
	...
	{
		return 'et_ophnupostoperative_translator';
	}
	...
	public function relations()
	{
		return array(
			...
			'translator_present' => array(self::BELONGS_TO, 'OphNuPostoperative_Translator_TranslatorPresent', 'translator_present_id'),
		);
	}
