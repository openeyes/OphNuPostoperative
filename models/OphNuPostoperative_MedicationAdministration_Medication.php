...
/**
 * This is the model class for table "ophnupostoperative_medicationadmin_medication".
 *
...
class OphNuPostoperative_MedicationAdministration_Medication extends BaseActiveRecordVersioned
{
	/**
	...
	{
		return 'ophnupostoperative_medicationadmin_medication';
	}
	...
	public function afterValidate()
	{
		...
		if ($this->end_date && !preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/',$this->end_date)) {
			$this->addError('end_date','End date has incorrect format');
		}
