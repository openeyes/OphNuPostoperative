...
/**
 * This is the model class for table "ophnupostoperative_vitals_drug".
 *
...
class OphNuPostoperative_Vitals_Drug extends BaseActiveRecord
{
	...
	{
		return 'ophnupostoperative_vitals_drug';
	}
	...
	public function getUnitAttributes()
	{
		...
		foreach (OphNuPostoperative_Vitals_Drug::model()->findAll() as $type) {
