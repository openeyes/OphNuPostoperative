...
class m140804_145001_use_measurements_system extends CDbMigration
{
	public function up()
	{
		...
		$this->addColumn('ophnupostoperative_vital','spo2_m_id','int(10) unsigned null');
		...
		$this->addColumn('ophnupostoperative_vital_version','spo2_m_id','int(10) unsigned null');
	...
	public function down()
	{
		...
		$this->dropColumn('ophnupostoperative_vital','spo2_m_id');
		...
		$this->dropColumn('ophnupostoperative_vital_version','spo2_m_id');
